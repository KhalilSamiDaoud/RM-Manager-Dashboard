...
/*! cash-dom 1.3.5, https://github.com/kenwheeler/cash @license MIT */ window.cash =
  (function () {
    ...
    function f(i) {
      if (!t) {
        var n = (t = e.implementation.createHTMLDocument(null)).createElement(
          "base"
        );
        ...
        (y[e] = function () {
          ...
          (y["outer" + t] = function (e) {
            return (
              this[0]["offset" + t] +
              (e
                ? H(this, "margin" + ("Width" === t ? "Left" : "Top")) +
                H(this, "margin" + ("Width" === t ? "Right" : "Bottom"))
                : 0)
            );
          });
      }),
            ...
            "ready" === t
              ...
              : (e &&
                ...
                this.each(function (e) {
                  ...
                  n &&
                    (s = function () {
                      i.apply(this, arguments), P(e, t, s);
                    }),
                    (function (t, e, i) {
    ...
    return (
      y.extend({
        ...
        offset: function () {
          ...
          return {
            top: t.top + i.pageYOffset - q.clientTop,
            left: t.left + i.pageXOffset - q.clientLeft,
          };
        },
            ...
            [
              {
                ...
                value: function () {
                  this._removeEventHandlers(),
                    //khalil updated this so it wont break on modal reloads --original: this._indicator.parentNode.removeChild(this._indicator),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.xMovement = 0),
                    (this.yMovement = 0),
                    (h =
                      i.getBoundingClientRect().top + M.getDocumentScrollTop()),
                    (d =
                ...
                value: function (e, i, n, s, o, a) {
                  ...
                  for (
                    ...
                    t.isArray(c.yearRange)
                      ? ((h = c.yearRange[0]), (d = c.yearRange[1] + 1))
                      : ((h = n - c.yearRange), (d = 1 + n + c.yearRange)),
                    u = [];
                    h < d && h <= c.maxYear;
                    h++
                  )
