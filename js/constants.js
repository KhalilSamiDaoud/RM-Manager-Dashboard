//JS style enums
const initMode = Object.freeze({ test: 1, file: 2, API: 3 });
const initEventEntry = Object.freeze({ test: 'Initialized in test mode', file: 'Initialized from file', API: 'Initialized from API'})
...
const simArea = Object.freeze({ DC: 'ERSA Simulation - DC Area', LA: 'ERSA Simulation - LA Area', Cust: 'ERSA Simulation - Custom Area' });
const windowType = Object.freeze({ statistics: 'statistics', log: 'eventlog', queue: 'tripqueue', unknown: 'unknown' });
const vehStatus = Object.freeze({ depot: 'In-Depot', route: 'In-Route' });
...
const dashedLinePath = 'M 0,-1 0,1';

export { initMode, tripType, vehStatus, simArea, windowType, vehicleIDletter, windowOptions, colors, initCoords, fixedStopLoopsDC, fixedStopLoopsLA, randTrip, depotSVG, dropoffSVG, pickupSVG, stopSVG, dashedLinePath, initEventEntry, APIColumns };
